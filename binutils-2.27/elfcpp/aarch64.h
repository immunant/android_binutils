...
enum
{
  ...
  R_AARCH64_MOVW_GOTOFF_G0_PRC = 0xe12c,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G0_PRC_NC = 0xe12d,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G1_PRC = 0xe12e,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G1_PRC_NC = 0xe12f,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G2_PRC = 0xe130,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G2_PRC_NC = 0xe131,	// G(GDAT(S+A))-GOT
  R_AARCH64_MOVW_GOTOFF_G3_PRC = 0xe132,	// G(GDAT(S+A))-GOT
};
